...
ClimateDataDayForecast climateDataDayForecastFromJson(String str) =>
    ClimateDataDayForecast.fromJson(json.decode(str));

String climateDataDayForecastToJson(ClimateDataDayForecast data) =>
...
class ClimateDataDayForecast {
  ...
  factory ClimateDataDayForecast.fromJson(Map<String, dynamic> json) =>
      ClimateDataDayForecast(
        msg: json["msg"],
...
class Hourly {
  ...
  factory Hourly.fromJson(Map<String, dynamic> json) => Hourly(
        ...
        apparentTemperature: json["apparent_temperature"] != null
            ? List<double>.from(
                json["apparent_temperature"].map((x) => x?.toDouble() ?? 0.0))
            : [],
        precipitationProbability: json["precipitation_probability"] != null
            ...
            : [],
        rain: json["rain"] != null
            ? List<double>.from(json["rain"].map((x) => x?.toDouble() ?? 0.0))
            : [],
        weatherCode: json["weather_code"] != null
            ? List<int>.from(json["weather_code"].map((x) => x ?? 0))
            : [],
      );
